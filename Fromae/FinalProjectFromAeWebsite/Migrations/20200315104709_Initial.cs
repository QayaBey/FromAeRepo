    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Istifadecilers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IstifadecilerId = table.Column<int>(nullable: false),
                    ProductId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Istifadecilers_IstifadecilerId",
                        column: x => x.IstifadecilerId,
                        principalTable: "Istifadecilers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "SubMenus",
                columns: new[] { "Id", "Link", "MainImg", "MenuId", "Name" },
                values: new object[,]
                {
                    { 1, "#", null, 1, "Telefonlar" },
                    { 18, "#", null, 7, "Hamam otağı" },
                    { 17, "#", null, 7, "Koridor" },
                    { 16, "#", null, 7, "BTekstil" },
                    { 15, "#", null, 6, "Beauty & Health" },
                    { 14, "#", null, 6, "Ətriyyat" },
                    { 13, "#", null, 5, "Gözəllik Məhsulları" },
                    { 12, "#", null, 5, "Məişət Avadanlıqları" },
                    { 11, "#", null, 5, "Mətbəx Avadanlıqları" },
                    { 10, "#", null, 4, "Foto" },
                    { 9, "#", null, 3, "Oyun" },
                    { 8, "#", null, 2, "Şəbəkə Avadanlığı" },
                    { 7, "#", null, 2, "Tabletlər üçün üzlüklər və qapaqlar" },
                    { 6, "#", null, 2, "Kompüter ehtiyyat hissələri" },
                    { 5, "#", null, 2, "Periferiya qurğuları" },
                    { 4, "#", null, 2, "Kompüter" },
                    { 3, "#", null, 1, "TV və audio" },
                    { 2, "#", null, 1, "Mobil aksessuarlar" },
                    { 19, "#", null, 7, "Qab-qacaq" },
                    { 20, "#", null, 7, "Camaşırxana" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_IstifadecilerId",
                table: "Orders",
                column: "IstifadecilerId");
